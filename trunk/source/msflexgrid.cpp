...
CPicture1 CMSFlexGrid::GetMouseIcon()
{
	LPDISPATCH pDispatch;
...
CPicture1 CMSFlexGrid::GetPicture()
{
	LPDISPATCH pDispatch;
...
CPicture1 CMSFlexGrid::GetCellPicture()
{
	LPDISPATCH pDispatch;
