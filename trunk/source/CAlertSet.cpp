// CAlertSetDlg.cpp : implementation file
// by 俞明录
...
CAlertSetDlg::CAlertSetDlg(CWnd* pParent /*=NULL*/)
: CTaiScreenParent(CAlertSetDlg::IDD, pParent)
{//应用程序类，主程序初始化，初始数据读取等
	m_nItem = -1;
	m_btAddtional[0] = 1;
	m_btAddtional[1] = 1;
	m_btAddtional[2] = 0;
	//{{AFX_DATA_INIT(CAlertSetDlg)
	m_sTitle = _T("");
	//}}AFX_DATA_INIT
...
void CAlertSetDlg::DoDataExchange(CDataExchange* pDX)
{
	CTaiScreenParent::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CAlertSetDlg)
...
BEGIN_MESSAGE_MAP(CAlertSetDlg, CTaiScreenParent)
	//{{AFX_MSG_MAP(CAlertSetDlg)
...
/////////////////////////////////////////////////////////////////////////////
// CAlertSetDlg message handlers

void CAlertSetDlg::OnOK() 
{//Tidxd结构
...
void CAlertSetDlg::OnDeleteStocks2() 
{
...
void CAlertSetDlg::OnAddStocksParent() 
{//Tidxd结构
	AddStocks();
	CAlertSystem::ListCtrlToSymbolType(m_symbolTypeArray,&m_liststockrange);
...
void CAlertSetDlg::OnSettingAdded() 
{
...
BOOL CAlertSetDlg::OnInitDialog() 
{
...
void CAlertSetDlg::SetInitData(ALERT_SET_ITEM &itemData)
{//对话框基类
...
void CAlertSetDlg::GetItemData(ALERT_SET_ITEM &itemData)
{
...
void CAlertSetDlg::OnKeydownStockList(NMHDR* pNMHDR, LRESULT* pResult) 
{
...
BOOL CAlertSetDlg::OnHelpInfo(HELPINFO* pHelpInfo) 
{
...
void CAlertSetDlg::NotifySubclass()
{//对话框基类
...
void CAlertSetDlg::OnSelchangedTreeFormularAll(NMHDR* pNMHDR, LRESULT* pResult) 
{
